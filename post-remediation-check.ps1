...
try {
    ...
    Show-Result "Legacy IE11 Removed" $(if ($feat.State -eq 'Disabled') { "OK" } else { "NOT SET (reboot pending?)" })
} catch { Show-Result "Legacy IE11 Removed" "MANUAL" "Could not verify on this OS/session" }
