...
# Collects the AMC VM inventory and adds it as a new "AMC" tab to the master Excel file (same format).
# The other tabs are not changed. Read-only against vCenter. A backup of the Excel file is saved first.
