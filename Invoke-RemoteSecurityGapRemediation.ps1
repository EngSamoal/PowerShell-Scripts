...
$ScriptBuild = '2026-08-28f-local-format'
...
Write-Host ("If the build above is not '2026-08-28f-local-format' you are running an OLD copy - update it.") -ForegroundColor DarkGray
if ($Apply) {
