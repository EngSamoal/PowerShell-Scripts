...
$ScriptBuild = '2026-08-28h-mii-workgroup-na'
...
Write-Host ("If the build above is not '2026-08-28h-mii-workgroup-na' you are running an OLD copy - update it.") -ForegroundColor DarkGray
if ($Apply) {
